        ...
        <div className="forms" style={{ display: formsDisplay }}>
          ...
          <div className="position-form">
            <form>
              ...
              <div className="submit-buttons">
                <button
                  onClick={this.handlePositionCurrentWeatherSubmit}
                  className="current-weather-button"
                >
                  Get <b>current weather</b>
                </button>
                <button
                  onClick={this.handlePositionForecastSubmit}
          ...
          <div className="city-form">
            <form>
              ...
              <p>
                *You may specify a country to help narrow the results, though
                it's not required.
              </p>
              <div className="submit-buttons">
                <button
                  onClick={this.handleCityCurrentWeatherSubmit}
                  className="current-weather-button"
                >
                  Get current weather
                </button>
                <button
                  onClick={this.handleCityForecastSubmit}
                  className="forecast-weather-button"
                >
          ...
          <div className="lat-long-form">
            <form>
              ...
              <div className="submit-buttons">
                <button
                  onClick={this.handleCoordsCurrentWeatherSubmit}
                  className="current-weather-button"
                >
                  Get current weather
                </button>
                <button
                  onClick={this.handleCoordsForecastSubmit}
                  className="forecast-weather-button"
                >
                  Get seven day forecast
                </button>
